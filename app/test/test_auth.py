...
class TestAuthBlueprint(BaseTestCase):
    ...
    def test_login_exception_raised(self, encode_auth_mock):
        """Test Exception handling for user login"""
        with self.client:
            # user registration
            new_user = User(
                username='username',
    ...
    def test_logout_with_invalid_token(self):
        ...
        with self.client:
            ...
            response, status_code = Auth.logout_user("")
            self.assertTrue(response['status'] == 'fail')
            self.assertTrue(response['message'] == 'Provide a valid auth token.')
